...
<script>
	...
	const menuToggleIcon = document.querySelector("button.mobile-menu-button > img");
	const menu = document.querySelector(".mobile-menu");
	const logo = document.querySelector('.navigation > .container > .text-site-logo')
	...
	menuToggleButton.addEventListener("click", () => {
		...
		if(menuToggleButton.classList.contains('open')){
			menuToggleIcon.src = '/wp-content/themes/framework-theme/assets/images/close-menu-icon.svg';
		} else{
			menuToggleIcon.src = '/wp-content/themes/framework-theme/assets/images/hamburger-menu-icon.svg';
		}
